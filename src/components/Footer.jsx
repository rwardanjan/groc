    ...
    <div className="footer-nav fixed bottom-0 border-t border-gray-200 z-50 w-full -translate-x-1/2 bg-white left-1/2 dark:bg-gray-700 dark:border-gray-600">
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        >
          <button type="button">
            {location.pathname === "/plan" ? (
              ...
              <svg
                className="w-7 h-7 text-gray-500 dark:text-gray-200 group-hover:text-black dark:group-hover:text-black"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
        ...
        >
          <button type="button">
            <svg
              className="w-5 h-5 text-gray-500 dark:text-gray-200 group-hover:text-black dark:group-hover:text-black"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 20 20"
